    ...
    class Level : IDisposable
    {
        ...
        private Tile LoadTile(char tileType, int x, int y)
        {
            switch (tileType)
            {
                ...
                // Various enemies
                case 'A':
                    return LoadEnemyTile(x, y, "MonsterA", true);
                case 'B':
                    return LoadEnemyTile(x, y, "MonsterB", true);
                case 'C':
                    return LoadEnemyTile(x, y, "MonsterC", true);
                case 'D':
                    return LoadEnemyTile(x, y, "MonsterD", true);
        ...
        /// </summary>
        private Tile LoadEnemyTile(int x, int y, string spriteSet, bool moving)
        {
            Vector2 position = RectangleExtensions.GetBottomCenter(GetBounds(x, y));
            enemies.Add(new Enemy(this, position, spriteSet, moving));
